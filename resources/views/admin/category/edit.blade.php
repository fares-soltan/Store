                    ...
                    <form action="{{ url('admin/category/'.$category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <img src="{{asset('/uploads/category/'.$category->image)}}" style="width: 60px; height: 60px;"/>
                                @error('image')<small class="text-danger">{{$message}}</small>@enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label>Status</label><br/>
                                Hidden <input type="checkbox" name="status" style="margin-top: 16px;"{{ $category->status == '1' ? 'checked':'' }} >
                            ...
                            <div class="col-md-12 mb-3">
                                <button type="submit" class="btn btn-primary btn-sm float-end" style="color: white;">Update</button>
                            </div>
                        </div>
                    </form>
                </div>
